...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 17, 2023 at 07:46 PM
...
(124, 'undefined', '2023-02-19 20:46:57', 94, 2),
...
--
ALTER TABLE `tbl_entry`
  MODIFY `entry_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=153;

--
-- AUTO_INCREMENT for table `tbl_entry_activity`
--
ALTER TABLE `tbl_entry_activity`
  MODIFY `entry_activity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=360;
