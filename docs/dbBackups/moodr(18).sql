...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2023 at 02:47 AM
...
(18, 'Exersize', 2, 9, 94),
(21, 'Test Act', 2, 11, 94),
(40, 'Test Actsd', 2, 9, 94),
(41, 'Test Actsddf', 1, 9, 94),
(42, 'Test Actff', 1, 9, 94),
(43, 'Test Actdasf', 1, 9, 94),
(44, 'a1', 2, 13, 94),
(45, 'a2', 2, 13, 94),
(46, 'a3', 2, 13, 94),
(47, 'a4', 2, 13, 94),
(48, 'relationship', 2, 13, 94);
...
(1, 'qA63^&8JX!#46#fdlK0Yi7eykKk2!Vi', 'allows access to all api endpoints', b'1');
...
--
ALTER TABLE `tbl_entry`
  MODIFY `entry_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;

--
-- AUTO_INCREMENT for table `tbl_entry_activity`
--
ALTER TABLE `tbl_entry_activity`
  MODIFY `entry_activity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=281;
