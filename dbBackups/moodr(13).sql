...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2023 at 01:22 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_update_entry` (IN `userId` INT, IN `entryId` INT, IN `entryNotes` TEXT, IN `moodName` VARCHAR(255), IN `activityCommaDelimStr` VARCHAR(1000))   BEGIN
	DECLARE moodId int(11);
...
(45, 'klklklklklklkl', '2023-01-13 23:16:19', 94, 66),
...
(52, 'qwqwqwqwqw  ', '2023-01-14 00:08:44', 94, 66),
(53, 'KKKKKKKKKJJJJJJJJGGGGGGGGG', '2023-01-14 00:32:44', 94, 68),
(54, 'qqqqqqsssssssssswwwwww', '2023-01-14 00:33:47', 94, 66),
(55, 'qwerqwerqwerqwer', '2023-01-14 02:06:35', 94, 69),
(56, 'adfadsfdsaf', '2023-01-14 02:08:35', 94, 68),
(57, 'vbnmvbnmvbnmvbnm\r\n  ', '2023-01-14 02:09:06', 94, 68),
(58, 'bigret\r\n  ', '2023-01-14 02:11:20', 94, 68),
(59, '\r\n  adsfadsf', '2023-01-14 02:17:13', 94, 66),
(60, 'q14', '2023-01-19 00:03:39', 94, 68),
(61, 'ABABABABABABC', '2023-01-21 18:03:45', 94, 70),
(62, 'TESTING SCRIPT REFACTORING', '2023-01-22 15:09:46', 94, 68),
(63, 'TESTING SCRIPT REFACTOR 2', '2023-01-22 15:33:57', 94, 66),
(64, 'DFG', '2023-01-22 15:37:27', 94, 69),
(65, '', '2023-01-22 23:33:10', 94, 70);
...
--
ALTER TABLE `tbl_entry_activity`
  MODIFY `entry_activity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=193;
