...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2022 at 01:00 AM
...
(2, 'test note 2', '2022-12-15 23:47:45', 94, 69);
...
--
ALTER TABLE `tbl_entry_activity`
  MODIFY `entry_activity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
